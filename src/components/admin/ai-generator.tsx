    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            <Select
              ...
              <SelectTrigger className={errors.skill ? "border-red-300" : ""}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                {skills.map((skillOption) => (
                  <SelectItem key={skillOption.value} value={skillOption.value}>
        ...
        <div>
          ...
          {errors.focus && (
            <p className="mt-2 text-sm text-red-600">{errors.focus.message}</p>
          )}
        </div>
      </div>
